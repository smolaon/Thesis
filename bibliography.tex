...
\bibitem{vmware_openstack_survey}

\bibitem{OpenStack_web}\emph{Openstack:  Open  source  cloud  computing  software},  2016.  [Online]. Dostupné z: \url{https://www.openstack.org}

\bibitem{neutron}DENTON, James. Learning OpenStack networking (Neutron): architect and build a network infrastructure for your cloud using OpenStack Neutron networking. Birmingham: Packt Publishing, 2014. Community experience distilled (Packt). ISBN 978-1-78398-330-8.
